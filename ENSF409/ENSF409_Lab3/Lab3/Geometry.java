...
public class Geometry{
	...
	private  static Geometry demo = new Geometry();
	...
	public void calculator(Shape shape){
		...
		System.out.println("The area, perimeter, and volume of " + shape.name + " are: " +
							two_dec.format(shape.area()) + ", " + two_dec.format(shape.perimeter()) + ", " + two_dec.format(shape.volume()) + ".");
	}
